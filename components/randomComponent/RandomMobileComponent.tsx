...
export default function RandomMobileComponent({
  targetProducts,
  targetCategory,
  targetSubCategory,
  count,
          ...
          <div className="w-full h-auto  col-span-9 gap-2">
            <Carousel
              ...
              renderItem={(item) => (
                ...
                >
                  <div className="w-36 h-52 md:w-60 md:h-96 flex flex-col justify-center items-center  shadow-lg relative rounded-2xl overflow-hidden">
                    <Image
                      src={item.image}
                      width={200}
                      height={200}
